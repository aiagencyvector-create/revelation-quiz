...
const DEPTH_LEVELS = {
  0: { label: 'Beginner', plan: 'Start with the 14-day reading plan — 20 min/day.' },
  ...
  return (
    <div className="result-page">
      <div className="result-header">
        ...
        <p className="result-intro">Based on your answers, here's your personalized recommendation.</p>
      </div>

      <div className="result-grid">
        {/* LEFT — Personalized result */}
        ...
        <div className="result-right">
          <div className="result-book-wrap">
          ...
          <ul className="result-inside">
            <li>163-page illustrated PDF guide</li>
            <li>Complete prophetic timeline</li>
          ...
          <p className="result-secure">Secure checkout via Stripe &middot; Instant PDF delivery</p>
        </div>
      </div>
    </div>
  );
